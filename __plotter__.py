...
def plot():
    path1 = '/home/indy/1965_28_01_2019/node10.csv'
    path2 = '/home/indy/1965_28_01_2019/node15.csv'
    path3 = '/home/indy/1965_28_01_2019/node20.csv'
    path4 = '/home/indy/1965_28_01_2019/node25.csv'

    metrics = ['ordered_batch_size_per_sec', 'avg_monitor_avg_latency', 'avg_request_queue_size',
               'max_view_change_in_progress', 'max_current_view', 'max_domain_ledger_size', 'timestamp']

    pd.read_csv(path1).loc[:, metrics].plot\
        (x='timestamp', subplots=True, cmap='cool', title='Node 10', figsize=(9, 4))
